...
<template>
    <div
        v-show="show"
        className="fixed z-[10000] shadow-lg border border-gray-500 inset-0 bg-gray-20 bg-opacity-75 flex items-center justify-center p-4 sm:p-6 transition-opacity duration-300 ease-out"
    >
        <div
